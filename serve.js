...
var child = exec(`node_modules/.bin/reveal-md ./classes/${process.argv[2] || ''}.md --disableAutoOpen --scripts scripts/styles.js,scripts/fragmentize.js,scripts/qr.js,scripts/notes.js,scripts/sync.js,scripts/timer.js --port 8080 --highlightTheme zenburn --theme blood`, function (err, stderr) {
    console.log(err);
    console.log(stderr);
